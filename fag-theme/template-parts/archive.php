	...
	<div class="p-4">
		...
		<?php if( has_post_thumbnail() ) : ?>
            <a href="<?php print esc_url( get_the_permalink() ); ?>">
				<?php the_post_thumbnail("post-thumbnail", ['class' => 'w-1/2 object-cover object-center rounded-t-lg shadow-sm transition duration-300 group-hover:shadow-xl shadow-gray-500/50 group-hover:-translate-y-2', 'title' => 'Feature image']); ?>
            </a>
		<?php endif; ?>
        <?php the_excerpt(); ?>
		<div class="flex items-center flex-wrap justify-between">
			...
			<a href="<?php print esc_url( get_permalink() ); ?>" class="text-sm inline-flex items-center md:mb-2 lg:mb-0">
				<?php print esc_html_e('Read More', 'tailfagtheme'); ?>
